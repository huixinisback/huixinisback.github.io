/* Handles listing your/other's profile

http://localhost:3000/profile/
http://localhost:3000/profile/wzy1lBNNhkhRgMH6KOFPvImMEBp2
...
const Profile = () => {
    ...
    // it keeps sending me to login page before i can do anything wth?
    // the async is too slow!

    // it says Begin:uid

    useEffect(() => {
      const getUserProfile = async () => {
        const q = query(collection(db, "users"), where("uid", "==", id), orderBy("uid"));
        // alert("Begin:"+id);
        await onSnapshot(q, (doc) => {
            //alert("Test1:"+JSON.stringify(doc.docs[0].data()));
    ...
    console.log(profile);
    // allow read, write; probably
  
    return (
      <div className="w-full">
        <div className="fixed top-0 z-10 w-full bg-white">
          <Navbar></Navbar> </div>
        <div className="flex bg-gray-100"> <div className="flex-auto w-[20%] fixed top-12">
            <LeftSide></LeftSide> </div>
          <div className="flex-auto w-[60%] absolute left-[20%] top-14 bg-gray-100 rounded-xl">
            <div className="w-[80%] mx-auto"> <div> <div className="relative py-4">
                  <img
